"""
URL configuration for mtflex project.
...
from workorders.views import DashboardOverviewView
...
urlpatterns = [
    ...
    path('workrequests/', include('workrequests.urls', namespace='workrequests')),
